...
public class MyProgressSessionImagesActivity extends AppCompatActivity {
    ...
    public class SessionimageAdapter extends RecyclerView.Adapter<SessionimageAdapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public SessionimageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_session_img, parent, false);
            SessionimageAdapter.ViewHolder holder = new SessionimageAdapter.ViewHolder(view);
            return holder;

        }

        @Override
        public void onBindViewHolder(SessionimageAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
