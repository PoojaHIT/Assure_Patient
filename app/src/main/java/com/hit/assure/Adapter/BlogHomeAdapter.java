...
public class BlogHomeAdapter extends RecyclerView.Adapter<BlogHomeAdapter.ViewHolder> {

    //vars
    private Context mContext;
    private List<BlogData> blogData;

    public BlogHomeAdapter(Context mContext, List<BlogData> blogData) {
...
//
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext, BlogDetailsActivity.class).putExtra("airtleId", blogData.get(position).getArticle_id()));
            }
        });
