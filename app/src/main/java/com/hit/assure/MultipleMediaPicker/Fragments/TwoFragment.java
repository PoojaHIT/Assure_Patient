package com.hit.assure.MultipleMediaPicker.Fragments;
...
import com.hit.assure.MultipleMediaPicker.Adapters.BucketsAdapter;
import com.hit.assure.MultipleMediaPicker.OpenGallery;
...
public class TwoFragment extends Fragment {
    ...
    private void populateRecyclerView() {
        BucketsAdapter mAdapter = new BucketsAdapter(bucketNames, bitmapList, getContext());
    ...
    public void getVideos(String bucket) {
        selected.clear();
        @SuppressLint("InlinedApi") Cursor cursor = getContext().getContentResolver()
