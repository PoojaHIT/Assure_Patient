...
public class Constant {
    ...
    public interface UrlPath {
      //  String BASE_URL_SUREPASS_FACE_MATCH = "http://api.tcscubo.com/ai_computer_vision/orbo/skin_analysis/v1/";
      String BASE_URL_SUREPASS_FACE_MATCH = "http://3.111.84.237/index.php/";
